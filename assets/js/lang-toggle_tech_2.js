...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function loadLanguage(lang) {
        fetch("/assets/js/lang_tech_2.js") // Fetch the JSON file
            ...
            .then(data => {
                ...
                document.getElementById("text_1").innerHTML = data[lang].text_1;
                document.getElementById("header_1").innerHTML = data[lang].header_1;
                document.getElementById("text_2").innerHTML = data[lang].text_2;
                document.getElementById("header_2").innerHTML = data[lang].header_2;
                document.getElementById("text_3").innerHTML = data[lang].text_3;
                document.getElementById("header_3").innerHTML = data[lang].header_3;
                document.getElementById("text_4").innerHTML = data[lang].text_3;
                document.getElementById("bul_p_1").innerHTML = data[lang].bul_p_1;
                document.getElementById("bul_p_2").innerHTML = data[lang].bul_p_2;
                document.getElementById("bul_p_3").innerHTML = data[lang].bul_p_3;
